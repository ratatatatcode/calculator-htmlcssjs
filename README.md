...
`June 18, 2026` `HTML` `CSS` `JS`<br>
Another small project to practice JavaScript fundamentals like DOM manipulation, arrays, loops, string handling, and turning button clicks into working calculations. I also experimented with dynamically generating the calculator UI instead of hardcoding every button.<br>
