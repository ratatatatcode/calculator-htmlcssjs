...
class MatchDataService {
  static preferencesRef = collection(db, COLLECTIONS.PREFERENCES);
  static matchesRef = collection(db, COLLECTIONS.MATCHES);
  static matchRequestsRef = collection(db, COLLECTIONS.MATCH_REQUESTS);
